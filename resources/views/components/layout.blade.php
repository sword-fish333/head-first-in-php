...
-->
<html lang="en" class="@if(session('dark_mode')) dark @else light @endif">
<!-- BEGIN: Head -->
<head>
    <meta charset="utf-8">
    ...
    <meta name="description"
          content="{{config('app.name')}} - Master PHP">
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    ...
    @endif
    <meta name="keywords"
          content="Master PHP theoretical concepts">
    <meta name="author" content="{{env('AUTHOR')}}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"
          integrity="sha512-DTOQO9RWCH3ppGqcWaEA1BIZOC6xxalwEsw9c2QQeAIftl+Vegovlnee1c9QX4TctnWMn13TZye+giMm8e2LwA=="
          crossorigin="anonymous" referrerpolicy="no-referrer"/>    <!-- BEGIN: CSS Assets-->
...
<div id="tooltip"
     class="tooltip fixed z-50 opacity-0 pointer-events-none max-w-xs bg-gray-800 text-white text-sm rounded-lg p-3 shadow-lg">
